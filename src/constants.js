...
export const LIGHT_COLORS = {
  ...
  "--color-primary-100": "hsl(239deg 90% 49%)",
  "--color-primary-300": "hsl(239deg 90% 49%)",
  "--color-primary-500": "hsl(239deg 90% 49%)",
  "--color-primary-700": "hsl(239deg 90% 49%)",
  "--color-primary-900": "hsl(239deg 90% 49%)",
  "--color-primary-contrast": "white",
  "--color-secondary-500": "hsl(328deg 100% 50%)",
  "--color-decorative-100": "hsl(48deg 33% 97%)",
  "--color-decorative-300": "hsl(48deg 33% 97%)",
  "--color-decorative-500": "hsl(48deg 33% 97%)",
  "--color-decorative-700": "hsl(48deg 33% 97%)",
  "--color-decorative-900": "hsl(48deg 33% 97%)",
  "--color-gray-0": "white",
...
export const DARK_COLORS = {
  ...
  "--color-primary-100": "hsl(48deg 33% 97%)",
  "--color-primary-300": "hsl(48deg 33% 97%)",
  "--color-primary-500": "hsl(48deg 33% 97%)",
  "--color-primary-700": "hsl(48deg 33% 97%)",
  "--color-primary-900": "hsl(48deg 33% 97%)",
  "--color-primary-contrast": "black",
  "--color-secondary-500": "hsl(328deg 100% 50%)",
  "--color-decorative-300": "hsl(228deg 83% 6%)",
  "--color-decorative-500": "hsl(228deg 83% 6%)",
  "--color-decorative-700": "hsl(228deg 83% 6%)",
  "--color-decorative-900": "hsl(228deg 83% 6%)",
  "--color-gray-0": "black",
...
LIGHT_COLORS["--color-selection-text"] = LIGHT_COLORS["--color-secondary-500"];
...
DARK_COLORS["--color-selection-text"] = DARK_COLORS["--color-secondary-500"];
